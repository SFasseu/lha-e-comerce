...
<body class="off-canvas-sidebar">
  ...
  <script src="{{asset('/admin')}}/assets/js/core/bootstrap-paper-design.min.js"></script>
  ...
  <!-- Control Center for admin Dashboard: parallax effects, scripts for the example pages etc -->
  <script src="{{asset('/admin')}}/assets/js/paper-dashboard.min.js?v=2.1.0" type="text/javascript"></script>
  <!-- admin Dashboard DEMO methods, don't include it in your project! -->
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#facebook').sharrre({
        ...
        url: 'https://demos.creative-tim.com/admin-dashboard-pro/examples/dashboard.html'
      });
