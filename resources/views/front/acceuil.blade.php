			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="http://127.0.0.1:8000/utilisateur/./img/shop01.png" alt="">
							</div>
							<div class="shop-body">
                            ...
                            <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="blog-view-box">
                                        <div class="media">
                                            <div class="media-left">
                                                <img src="{{asset('/utilisateur')}}/http://127.0.0.1:8000/utilisateur/./img/client1.png" class="media-object">
                                            </div>
                                ...
                                <div class="item active">
                                    ...
                                    <div class="blog-view-box">
                                        <div class="media">
                                            <div class="media-left">
                                                <img src="{{asset('/utilisateur')}}/http://127.0.0.1:8000/utilisateur/./img/client2.png" class="media-object">
                                            </div>
                                            <div class="media-body">
                                ...
                                <div class="item">
                                    ...
                                    <div class="blog-view-box">
                                        <div class="media">
                                            <div class="media-left">
                                                <img src="{{asset('/utilisateur')}}/http://127.0.0.1:8000/utilisateur/./img/client3.png" class="media-object">
                                            </div>
                                            <div class="media-body">
